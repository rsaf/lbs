 ...
 */
  ...
  lbs.routes['/workspace/services/allbookings'] = {mod: 'lbs.workspace.services.grouped', location: '/workspace/services/main.js'};
  ...
  create:function(){
    ...
    lbs.workspace.services.grouped = this;
    delete this.deps;
    delete this.create;
  }
  ,basePath:'/workspace/services'
  ,deps:['/workspace','/global:modal','/workspace/services']
  ,container:'#right_container'
  ,routeParams:null
  ,render : function render(arg){
    var data = {
