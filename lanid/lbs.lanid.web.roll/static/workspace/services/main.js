 ...
 */
  ...
  lbs.modules['/workspace/services'] = {
    ...
    ,PriceList:function PriceList(arg){
      ...
      var index = lbs.util.find({arr:lbs.workspace.services.list.modalList,key:"_id",val:this.servicePoint});
      if(index!==-1){
        this.pc=lbs.workspace.services.list.modalList[index].postalCode;
      }
    }
  ...
  lbs.modules['/workspace/services/myservicepointsnew'] = {
    ...
    ,saveServicePoint : function(e){
      ...
      //@todo:here we should see if it's valid before submitting
          ...
          this.servicePoint.sppc = lbs.profile.basic.corporationPublicName.value;   //todo this assumes the user will always be logged ant the profile loaded.


          if(this.servicePoint.postalCode  === 'online'){
              console.log('this is online----');
              this.servicePoint.servicePointAddress  = '云端网点';
      ...
      lbs.modHelper.getMessage(
            ...
            ,'POST'
            ,{json:JSON.stringify({pl:{servicePoint:this.servicePoint},company:lbs.profile?lbs.profile.basic.corporationPublicName.value:''})})//data to post
      .then(function resolve(msg){
       ...
       // me.addedNew(msg.pl);
        lbs.workspace.services.list.render();  //todo render instead of me.addedNew above, to update the list values;
  ...
  lbs.modules['/workspace/services/myservicepointsviewedit'] = {
    ...
    ,render : function render(arg){
        ...
        .then(function(msg){
          ...
          return lbs.modHelper.getMessage(lbs.workspace.services.endPoints.servicePointTypes,true,{})//CHACHING SERVICE POINT TYPE
        })
        .then(function(msg){
          var data = {
            parentContainer : arg.container
    ...
    ,saveServicePoint : function(e){
      ...
      this.changeServicePoint._id = this.servicePoint._id;
          ...
          if(this.changeServicePoint.postalCode  === 'online'){
              console.log('this is online----');
              this.changeServicePoint.servicePointAddress  = '云端网点';
      ...
      .then(function resolve(msg){
        ...
        //me.updated(msg.pl);
           ...
           lbs.workspace.services.list.render();  //todo rerender instead of me.upadate abovce to update the list values;
  ...
  lbs.modules['/workspace/services/myservicesnew'] = {
    ...
    ,render : function render(arg){
      ...
      arg.listView = '/workspace/services/myservicepointslist.html'
      ...
      lbs.modHelper.getMessage(
          ...
          ,{}
            ...
            arg.whichMod = '/workspace/services/myservicepoints';
    ...
    ,addPriceList : function addPriceList(e){
      ...
      if(e && e.target && !e.target.checked){
          ...
          //lbs.util.emptyUi('#'+e.target.value);   todo empty ui when deselected
    ...
    ,saveService: function(e){
      ...
      lbs.modHelper.getMessage(
            ...
            ,'POST'
            ,{json:JSON.stringify({pl:{service:this.service},company:lbs.profile?lbs.profile.basic.corporationPublicName.value:''})}
      ).then(function resolve(msg){


              console.log('saaaaavvvvvviiiiing service-----');
        //re set to clean values and close the dialog
        //me.addedNew(msg.pl);

         lbs.workspace.services.list.render();  //todo rerender to update the list values;
  ...
  lbs.modules['/workspace/services/myservicesviewedit'] = {
    ...
    ,addPriceList : function addPriceList(e){
      ...
      if(e && e.target && e.target.checked){
        ...
        //todo: the commented part of this function was preventing the user from changing the service point values
        //if(itemIndex!==-1&&this.service.PriceList[itemIndex]._id){
        //    console.log('was there before-----');
        //
        //
    ...
    ,saveService: function(e){
      ...
      lbs.modHelper.getMessage(
        ...
        //me.updated(msg.pl);
              ...
              lbs.workspace.services.list.render();  //todo rerender instead of me.upadate above to update the list values;
  ...
  create:function(){
    ...
    this.handlers['business:downloadRecords']=function(e){
        me.downloadRecords(e);
    }
  ...
  ,handlers:{}
  ,downloadRecords : function downloadRecords(e){
    var me = this;
    ...
    var vargs = {queryData:{}};
    if(searchText && searchText.val()) vargs.queryData.sk = searchText.val();
    if(searchStart && searchStart.val()) vargs.queryData.sd = searchStart.val();
    if(searchEnd && searchEnd.val()) vargs.queryData.ed = searchEnd.val();
          vargs.queryData.ps = 1234567890;
          vargs.queryData.p = 0;

    lbs.modHelper.getMessage('/workspace/services/downloadBusinessRecords.json',true,{},"GET",vargs.queryData)
        .then(function(r){
            window.location = (r.pl.url);
        })
  }
...
lbs.modules['/workspace/services/myserviceslist'] = {
    ...
    ,create : function(){
        ...
        this.handlers['service:delete']=function(e){
            lbs.basemodule["general:list"].deleteEntity({
                ...
                ,code:'serviceCode'
                ,entityName:'service'
                ,listMod:lbs.workspace.services.list
    ...
    ,render : function render(arg){
      ...
      return  lbs.modHelper.getMod('/workspace/services:list')
    ...
    //    };
    //}
    ,openDetail : function openDetail(e,sencondParm){
        lbs.modHelper.getMod('/workspace/services/myservicesviewedit')
            .then(function(mod){
                return mod.render({
                    container:'#platformAPIsModal'
                    ,entityId:e.target.getAttribute('data-id')
                    ,hideEditBtn:sencondParm?sencondParm.hideEditBtn:false
                });
            });
    }
    ,deps:['/workspace/services']
...
lbs.modules['/workspace/services/myservicepointslist'] = {
    ...
    ,render : function render(arg){
        ...
        console.log('/workspace/services/myservicepointslist-----------------render--------');
  ...
  ,render : function render(arg){
          ...
          if(arg&&arg.whichMod){
              ...
              arg.listEndPoint  =  lbs.workspace.services.routeParams[arg.whichMod].listEndPoint;
              arg.modalList = true;

          }
          else{
             data =  lbs.workspace.services.routeParams[url];
          }

          lbs.util.merge(data, arg);

          arg.listView = arg.listView;



          if(arg.modalList){
              return lbs.basemodule['general:modal:list'].render.call(this,arg);
          }
          else{
              return lbs.basemodule['general:list'].render.call(this,arg);
          }
  ...
  ,rerender : function rerender(arg){
          ...
          if(arg&&arg.modalList){

              return lbs.basemodule['general:modal:list'].rerender.call(this,arg)
                  .then(function(){
