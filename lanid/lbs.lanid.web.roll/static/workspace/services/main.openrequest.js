 ...
 */
  ...
  lbs.modules['/workspace/services'] = {
    ...
    this.routeParams= {//todo this part was added to keep the moduleconsitent with the other modules and make the pagination work normaly
      ...
      console.log('services created-------',lbs.workspace.services);
  ...
  lbs.modules['/workspace/services/myservicepoints'] = {
    ...
    ,render : function render(arg){
      ...
      var data =  lbs.workspace.services.routeParams[url];
       console.log('myservicepoints render--------');
      ...
      ,rerender : function rerender(arg){
        ...
        return lbs.basemodule["general:list"].rerender.call(this,arg)
            .then(function(){
              ...
              console.log('/workspace/services/myserviceslist--------',me.containerToSet);
              lbs.actionHandler({
  ...
  lbs.modules['/workspace/services/myservicepointslist'] = {
    ...
    ,rerender : function rerender(arg){
      ...
      return lbs.basemodule["general:list"].rerender.call(this,arg)
          .then(function(){
        console.log('/workspace/services/myservicepointslist--------',me.containerToSet);
...
lbs.modules['/workspace/services/myservicepointsnew'] = {
  ...
  lbs.modules['/workspace/services/myservicesviewedit'] = {
      ...
      ,render : function render(arg){
        ...
        console.log('myservicesviewedit render-------',arg);
        ...
        lbs.modHelper.getMessage(
            ...
            , 'GET'
            , {_id: arg.entityId}//can be either code or _id
        ).then(function(msg){
              me.service=msg.pl;
  ...
  lbs.modules['/workspace/services/myservicepointsviewedit'] = {
    ...
    ,render : function render(arg){
      ...
      console.log('myservicepointsviewedit render-------',arg);
  ...
  lbs.modules['/workspace/services/detail'] = {
    container:'nothing'
    ,render : function render(arg){  // render either myservicepoints or myservices module, then render the corresponding viewedit module(myservicepointsviewedit or myservicesviewedit)

      //@todo: use url like /workspace/services/myservices/view/service/54d9b0a3b39dc61978f661b5
      var url = jQuery.param.fragment().split("/");

          console.log('------1');
      
      var mod = (url[url.length-2]==="servicepoint")?'myservicepoints':"myservices";
      //var modContainer = (mod==='myservices')?"#newServiceModal":"#newServicePointModal";

      var modContainer = '#platformAPIsModal';


      console.log('modContainer',modContainer);

      var id = url[url.length-1];//for servicepoint
