 ...
 // Load the HTML template
  $.get("/processes/verifications/groupIDForm.html", function(d){
  ...
  $(document).ajaxStop(function () {
                           ...
                           $('.selectpicker').selectpicker();
                            updateWorkSpaceRightContainerOnClick(".applicationNextStep","/processes/verifications/groupIDFormPayment");
