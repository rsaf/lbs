 ...
 // Load the HTML template
  $.get("/processes/photoservice/photoServices.html", function(d){
  ...
  $(document).ajaxStop(function () {
                           ...
                           $('.selectpicker').selectpicker();
                            ...
                            paddingEffecfts();
                            table_effects();
                          updateWorkSpaceRightContainerOnClick(".toPhotoPrinting","/processes/photoservice/photoPrinting");
                          updateWorkSpaceRightContainerOnClick(".toPhotoShooting","/processes/photoservice/photoShooting");
