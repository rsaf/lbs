...
var photoSchema = new paramMongoose.Schema({
    ...
    sg:{type:String, default:'10'}, //Stage, possible values {10 'original',20 'inspection', 30 'correction', 40 'processing-watermark', 41 'processing-resizing', 50 'activity', 60 'personal', 70 'corporate' }
    st:{type:String, default:'100'}, //Status, possible values {100: pending, 200:wip,  300:success, 400: rejected }
    rc:String, //business activity response code code
    ac:String,
    tc: {type: String}, // business activity transaction code
    photourl: String,
    uri: String, // String to physical photo location (original image)// AC1279908_SCM15900655434_UC12996987669_OC_2079877898.jpg
    urll:String, //Large version of the image
    urls:String, //small version of the image
    urlm:String, //medium version of the image
    ign: String,  // imageName
    cat: String, //corresponding activity type
    can: String, //corresponding activity name
    ds:{type:Boolean, default: false}
    //AC: activity code, SC special code and M index type is mobile, UC user code, OC organizational code
});
...
//step1: 10: photo is uploaded, status is set to success, no pending, WIP, and reject status
//step2: 20: photo is sent to inspection, status is set to pending; photo is opened, status is set to wip; photo is approved, status is set to success, or rejected status is set to rejected
//step3: 30: photo is sent to correction, status is set pending; photo is downloaded, status is set to WIP, photo is uploaded, status is set to approved, or rejected status is set to rejected
//step4: 40: photo is sent to for watermark, status is set WID; photo is downloaded, status is set to WIP, photo is uploaded, status is set to approved, or rejected status is set to rejected