...
return Q.all([p1]).then(function(r1){
        //console.log(r);
        mongoose = r1[0].pl.fn;
        console.log('\nism: ism has received mongodb dependency: ' + mongoose.connection.name + ' with readyState: ' + mongoose.connection.readyState);
         var r = {pl: {pm: 'ism initialization done! '}, er: null};
         return Q(r);
    });
