    ...
    var FormMetaSchema = new paramMongoose.Schema({
        ...
        fd: { //form definition
            fields: [{ //fields in the form
                ...
                dv: String, //default value, if it is checkbox or radio then this is not the same as value
                vt: String, //Number, String, Date, Boolean, radio,
            ...
            template: String, //form template's file reference, typically xlsx
            fcd:  {type: Date, default: Date.now}    // form creation date
        }
        ,fc:String //form code
    });
