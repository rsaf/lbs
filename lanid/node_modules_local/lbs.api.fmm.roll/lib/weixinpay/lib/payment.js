...
var Payment = function (config) {
  URLS.UNIFIED_ORDER = config.URLS.UNIFIED_ORDER;
  URLS.ORDER_QUERY = config.URLS.ORDER_QUERY;
  URLS.REFUND = config.URLS.REFUND;
  URLS.REFUND_QUERY = config.URLS.ORDER_QUERY;
  URLS.DOWNLOAD_BILL = config.URLS.DOWNLOAD_BILL;
  URLS.SHORT_URL = config.URLS.SHORT_URL;
 ...
 //console.log("configs", config);
  ...
  this.pfx = config.pfx.trim()  ;
  this.notify_url = config.notify_url;
  this.return_url= config.return_url;

  //this.pfx = fs.readFileSync(config.pfx.trim());
  //console.log(config.pfx.trim());
  //this.pfx = config.pfx;
  //this.pfx = fs.readFileSync(config.pfx.trim());
 ////console.log("loaded configs data", this);
...
Payment.prototype._httpRequest = function(url, data, callback){
    ...
    console.log("will be calling http", url);
...
Payment.prototype._httpsRequest = function(url, data, callback){
  var parsed_url = url_mod.parse(url);
   console.log("secured post url", url);
    //pfx: this.pfx,
...
Payment.prototype._signedQuery = function(url, params, options, callback){
  ...
  params = this._extendWithDefault(params, [
   ...
   console.log("FMM PREPSIGNED PARAM", params);

  params = _.extend({
    "sign": this._getSign(params)
  }, params);
   console.log("getting long url ..", params.long_url);
  if(params.long_url){
  ...
  var request = (options.https ? this._httpsRequest : this._httpRequest).bind(this);
   ...
   //console.log("xlm building",params);
