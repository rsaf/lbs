...
define(['cbos'],function(cbos){
    ...
    cbos.directives('collapseWidth', ['$transition','$timeout', function ($transition, $timeout) {
        return {
            link: function (scope, element, attrs) {
                scope.expandOrcollapase = scope.expandOrcollapase ||'Expand';
    ...
    cbos.directives('scrollPosition', function($window) {
        return {
            scope: {
                scroll: '=scrollPosition'
            },
            link: function(scope, element, attrs) {
                element.on('click',function(){ console.log('-----------windowEl.scrollTop()--------',element.scrollTop());});
            }
        };
    });
