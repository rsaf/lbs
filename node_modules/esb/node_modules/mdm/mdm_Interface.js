...
function sendEmailMessage (m){
  var oEmail = new Email(); //exposes instance methods
  var r ={"pl":null, "er":null};
  var deferred = Q.defer();
oEmail.sendEmail(m.pl, function(paramError, paramData){
  if(!paramError){
    r.pl = paramData;
    deferred.resolve(r);
  }
...
exports.operations = [init,instantiate, sendEmailMessage];
