...
module.exports = function(paramMongoose, paramSmtp) {
    ...
    emailSchema.methods.sendEmail = function(paramEmailMessage, paramCallback) {
        ...
        this.save(function(parammError, parammMessage) {
            ...
            if (!parammError) {
                console.log("messages temporary save.." + parammMessage);
                paramSmtp.sendMail({
                    ...
                    if (!parammmError) {
                        ...
                        parammMessage.save(function(parammmmError, parammmmMessage) {
                            if (parammmmMessage) {
                             ...
                             return  paramCallback(parammmmError, null);
                            }
                        });
                    }
                    else {
                      return  paramCallback(parammmError, null);
                    }
                });
            }
            else {
